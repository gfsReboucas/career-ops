...
Thanks for your interest in contributing! Career-Ops is built for Codex-first, CLI-agnostic agent workflows, and you can use Codex for development too.
...
- Keep modes language-agnostic when possible (Codex and other agents can handle both EN and ES)
