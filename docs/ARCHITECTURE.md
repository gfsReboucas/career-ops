...
Each worker is a headless AI CLI instance. The bundled `batch-runner.sh` defaults to `codex exec --sandbox workspace-write -` and also supports `--cli claude` for Claude Code compatibility. Workers produce:
- Report .md
- PDF
- Tracker TSV line
